...
import org.veupathdb.service.eda.generated.model.BeeswarmSpec;
import org.veupathdb.service.eda.generated.model.VariableSpec;

import static org.veupathdb.service.eda.ds.util.RServeClient.useRConnectionWithRemoteFiles;

public class BeeswarmPlugin extends AbstractPlugin<BeeswarmPostRequest, BeeswarmSpec> {

  @Override
  public String getDisplayName() {
    return "Beeswarm plot";
  }

  @Override
  public String getDescription() {
    return "Visualize distribution of a continuous variable";
  }
  ...
  @Override
  protected Class<BeeswarmSpec> getVisualizationSpecClass() {
    return BeeswarmSpec.class;
  }
  ...
  @Override
  protected void validateVisualizationSpec(BeeswarmSpec pluginSpec) throws ValidationException {
  ...
  @Override
  protected List<StreamSpec> getRequestedStreams(BeeswarmSpec pluginSpec) {
  ...
  protected void writeResults(OutputStream out, Map<String, InputStream> dataStreams) throws IOException {
    BeeswarmSpec spec = getPluginSpec();
    ...
    Number jitter = spec.getJitter();
    String showMedian = spec.getMedian() != null ? spec.getMedian().getValue() : "FALSE";
    ...
    useRConnectionWithRemoteFiles(dataStreams, connection -> {
      ...
      String outFile = connection.eval("plot.data::beeswarm(data, map, " +
          jitter + ", " + 
          showMedian + ")").asString();
