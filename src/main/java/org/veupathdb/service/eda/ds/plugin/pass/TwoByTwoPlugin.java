    ...
    return new ConstraintSpec()
      ...
      .pattern()
        .element("yAxisVariable")
          .minValues(2)
	  .maxValues(2)
	  .description("Variable must have exactly 2 unique values and be from the same branch of the Entity Tree as the X-axis variable.")
        .element("xAxisVariable")
	  .minValues(2)
	  .maxValues(2)
          .description("Variable must have exactly 2 unique values and be from the same branch of the Entity Tree as the Y-axis variable.")
