...
public class AppsMetadata {
  ...
  public static final AppsGetResponse APPS = apps(
      ...
      app("abundance", "Ranked Abundance", "RankedAbundanceComputation",
          "Plot the top n taxa, pathways, or genes from any study, ranked by either the median, maximum, variance, or third quartile of relative abundance.",
          List.of(MICROBIOME_PROJECT),
      ...
      app("betadiv", "Beta Diversity", "BetaDivComputation",
          "Visualize between-sample (beta) comparisons in microbial diversity, using Bray-Curtis dissimilarity, Jensen-Shannon Divergence, and Jaccard Index",
          List.of(MICROBIOME_PROJECT),
