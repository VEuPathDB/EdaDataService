...
import org.veupathdb.service.eda.generated.model.FilledareaSpec;
import org.veupathdb.service.eda.generated.model.VariableSpec;

import static org.veupathdb.service.eda.ds.util.RServeClient.useRConnectionWithRemoteFiles;

public class FilledareaPlugin extends AbstractPlugin<FilledareaPostRequest, FilledareaSpec> {

  private static final Logger LOG = LogManager.getLogger(FilledareaPlugin.class);
  
  @Override
  public String getDisplayName() {
    return "Filled area plot";
  }
  ...
  @Override
  protected Class<FilledareaSpec> getVisualizationSpecClass() {
    return FilledareaSpec.class;
  }
  ...
  @Override
  protected void validateVisualizationSpec(FilledareaSpec pluginSpec) throws ValidationException {
  ...
  @Override
  protected List<StreamSpec> getRequestedStreams(FilledareaSpec pluginSpec) {
  ...
  protected void writeResults(OutputStream out, Map<String, InputStream> dataStreams) throws IOException {
    FilledareaSpec spec = getPluginSpec();
