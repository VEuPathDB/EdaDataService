    ...
    return new ConstraintSpec()
      ...
      .pattern()
        ...
        .element("overlayVariable")
          .types(APIVariableType.NUMBER, APIVariableType.STRING, APIVariableType.INTEGER) 
          .description("Variable must be a number or string, and be of the same or a parent entity as the X-axis variable.")
