    ...
    return new ConstraintSpec()
      ...
      .pattern()
        .element("yAxisVariable")
          .maxValues(8)
          .description("Variable must have 8 or fewer unique values and be from the same branch of the Entity Tree as the X-axis variable.")
        .element("xAxisVariable")
          .maxValues(10)
          .description("Variable must have 10 or fewer unique values and be from the same branch of the Entity Tree as the Y-axis variable.")
